...
| `s3m` `opl2` | Attempting to play an S3M file with Adlib/OPL2 instruments does not produce the expected output. The OPL2 code has something wrong with it or maybe it's something related to how the mixing system works. Either way, it sounds attrocious. |
